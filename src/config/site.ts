...
export const BUSINESS = {
  ...
  address: {
    ...
    country: "India",
    pin: "140301",
    /** Confirmed by the owner 2026-09-15. Matches the GST certificate, whose
     *  own address fields are filled into the wrong slots ("Road/Street: 14
     *  KANG COLONY", "Name Of Premises: BHAGOO MAJRA"). */
    street: "Shop No. 14, Kang Colony, Bhagoo Majra",
  },
  ...
  contact: {
    ...
    // Times supplied by the owner 2026-09-07, days confirmed 2026-09-15:
    // open every day, no weekly closing.
    hours: "6:00 am – 10:00 pm",
    hoursDays: "Open every day",
  },
